...
const app = (0, _vue.createApp)({
    ...
    mounted () {
        fetch('/prueba.json').then((response)=>response.json()).then((data)=>{
...
},{"vue":"gs3Mk","./data.json":"aLYkf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gs3Mk":[function(require,module,exports,__globalThis) {
/**
* vue v3.5.13
...
},{"@vue/shared":"3SM3y","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aLYkf":[function(require,module,exports,__globalThis) {
