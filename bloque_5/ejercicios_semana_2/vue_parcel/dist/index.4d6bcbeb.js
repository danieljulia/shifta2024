...
function render(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("div", _hoisted_1, [
        _cache[3] || (_cache[3] = (0, _vue.createElementVNode)("h1", null, "Mi Lista de Tareas", -1 /* HOISTED */ )),
        (0, _vue.createCommentVNode)(" Formulario para agregar tareas "),
        (0, _vue.createElementVNode)("div", _hoisted_2, [
            (0, _vue.withDirectives)((0, _vue.createElementVNode)("input", {
                ...
                onKeyup: _cache[1] || (_cache[1] = (0, _vue.withKeys)((...args)=>$options.addTodo && $options.addTodo(...args), [
                    "enter"
                ])),
        ...
        (0, _vue.createCommentVNode)(" Lista de tareas "),
        (0, _vue.createElementVNode)("ul", _hoisted_3, [
            ((0, _vue.openBlock)(true), (0, _vue.createElementBlock)((0, _vue.Fragment), null, (0, _vue.renderList)($data.todos, (todo)=>{
                return (0, _vue.openBlock)(), (0, _vue.createElementBlock)("li", {
                    ...
                    }, (0, _vue.toDisplayString)(todo.text), 3 /* TEXT, CLASS */ ),
                    (0, _vue.createElementVNode)("button", {
                        onClick: ($event)=>$options.removeTodo(todo.id)
                    }, " Eliminar ", 8 /* PROPS */ , _hoisted_5)
                ]);
            }), 128 /* KEYED_FRAGMENT */ ))
        ]),
        (0, _vue.createCommentVNode)(" Estad\xedsticas "),
